	...
	\subsection{Cómo lleva a cabo la gestión de recursos}
        ...
        \begin{itemize}
          ...
          \item \textbf{Task.} Es con esta opción con la que se asignan los
            ...
            Pero además de asignar recursos, también se puede:
            \begin{itemize}
              \item Planificar las fechas de inicio y fin para las cuales el
                recurso estará disponible para realizar la tarea (Campos
                \emph{Start}, \emph{Due} y \emph{End}).
              \item Definir el coste del recurso (Campo \emph{Cost}).
              \item Indicar el número de instancias del recurso que se
                asignarán a la tarea, si existe más de una instancia del
                recurso (Campo \emph{Qty}).
              \item Definir la prioridad que tiene la tarea (Campo
                \emph{Priority}).
              \item Indicar el tanto por ciento de la tarea que se ha
                completado (Campo \emph{Complete}).
              \item Indicar el estado de la tarea (en proceso, finalizada,
                nueva, etc.) (Campo \emph{Status}).
              \item Especificar el tipo de tarea a realizar (Campo \emph{Task
                Type}).
              \item Definir las horas de trabajo y la duración de la tarea
                (Campos \emph{Work} y \emph{Duration}).
             \end{itemize}

               Todo ello sirve para poder generar el \emph{Diagrama de
...
Aparte de las características mencionadas anteriormente, este tipo de
...
diferentes.
  ...
  \subsection{Información general}
	...
	\subsection{Cómo lleva a cabo la gestión de documentos}
        ...
        En la parte izquierda de la aplicación, también puede verse la lista de
        pestañas a las que se tiene acceso en cada momento.

        La primera de ellas, la que aparece desplegada nada más iniciar el
				programa, es la pestaña (lateral) de \textbf{Proyectos}. En esta
				pestaña se ve el listado de todos los proyectos (ya que esta es la
				opción que está seleccionada por defecto) y pinchando sobre cada uno
				de ellos, en el lado derecho de la ventana, nos aparece la información
				referente a ese proyecto, los ficheros que contiene y la actividad
				que se ha realizado. Si por el contrario, se selecciona la opción de
				\textbf{Mis Cosas} lo que se muestra es el listado de documentos sobre
				los que está trabajando la persona registrada.

        La pestaña (superior) de \emph{Proyectos} permite crear
        nuevos proyectos y nuevas tareas; para ello se selecciona la opción
        \emph{Añadir}, se decide si se añade un proyecto o una tarea y se
				completan los reportes que se muestran en las figuras \ref{IMG5PM2} y
        \ref{IMG5PM3}.

        \imagen{5pm-anadirproyecto.png}{8}{Vista del reporte a rellenar para
        crear un proyecto}{IMG5PM2}
    
        \imagen{5pm-anadirtarea.png}{8}{Vista del reporte a rellenar para
        ...
        La figura \ref{IMG5PM5} muestra un ejemplo de la ventana emergente
				que permite añadir documentos a una tarea o proyecto. 

        \imagen{5pm-anadirdocumento.png}{10}{Vista de la ventana \emph{Añadir
          Documento}}{IMG5PM5}
        ...
        proyectos que se deseen en las fechas que se elijan. Se muestra un
...
la gestión de proyectos.
	...
	\subsection{Sistema de seguimiento de incidentes}
        ...
        \imagen{redmine-crearpeticion.png}{12}{Vista de la pestaña de 
				\emph{Nueva petición}}{IMGRED31}
	...
	\imagen{redmine-gantt.png}{12}{Diagrama de Gantt de un proyecto}{IMGRED51}
	...
	\imagen{redmine-vistatarea.png}{12}{Vista general de una tarea}{IMGRED71}
