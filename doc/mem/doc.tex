...
desarrolladora es \emph{Edgewall Software}, de origen sueco. \cite{TRA}
  ...
  \subsection{Información general}
	...
	\subsection{Características}
        \emph{Trac} es software libre y está desarrollado en
        \emph{Python}.
        
        Permite hiperlinks de información entre la base de
        datos de errores, el sistema de control de versiones y el contenido
        de la wiki. También sirve como interfaz para los sistemas de control
        de versiones e incluye otras caracteristicas como:
        \begin{itemize}
...
una buena gestión permitirá que el desarrollo se realize más rápida y
eficientemente.
...
\emph{MindGenius Business} y \emph{MindGenius Education}. 
  ...
  \subsection{Información general}
	...
	\subsection{Características}
        ...
        Por último, permite obtener el diagrama de \emph{Gantt} que se
